...
[![Total Extensions](https://img.shields.io/badge/Total%20Extensions-500+-blue?style=for-the-badge)](#)
[![Categories](https://img.shields.io/badge/Categories-16-green?style=for-the-badge)](#)
[![Active Contributors](https://img.shields.io/badge/Contributors-200+-orange?style=for-the-badge)](#)
...
- [axiosdevs/agentscoin-claude-extension](https://github.com/axiosdevs/agentscoin-claude-extension) - Give your AI agent its own money — create a wallet, get AGENT from the faucet, send, and create/trade tokens on a live EVM chain. One-click Claude Desktop extension (.mcpb).
...
- [⚙️ DXT CLI](https://github.com/anthropics/dxt) - Command-line tools for extension development

### 🧪 Testing & Debugging
- [🔍 MCP Inspector](https://github.com/modelcontextprotocol/inspector) - Debug and test MCP servers
- [📊 Extension Analytics](https://docs.anthropic.com) - Monitor extension usage and performance
- [🛡️ Security Scanner](https://github.com/anthropics/dxt-security) - Validate extension security
...
### 📖 Learning Resources
- [🎓 Extension Development Course](https://docs.anthropic.com/en/docs/claude-code) - Complete guide to building extensions
- [💡 Best Practices Guide](https://modelcontextprotocol.io/introduction) - Industry standards and patterns
- [🔧 Troubleshooting Guide](https://docs.anthropic.com/en/docs/claude-code/troubleshooting) - Common issues and solutions
- [🎯 Performance Optimization](https://docs.anthropic.com) - Making extensions faster and more efficient

### 🎥 Video Tutorials
- [📹 Building Your First Extension](https://youtube.com/watch?v=extension-tutorial) - Step-by-step walkthrough
- [🎬 Advanced Extension Patterns](https://youtube.com/watch?v=advanced-patterns) - Professional development techniques
- [🎞️ Community Showcase](https://youtube.com/watch?v=community-showcase) - Real-world extension examples
...
2. **Add** your extension to the appropriate category
3. **Follow** the format: `[Extension Name](link) - Brief description`
4. **Submit** a pull request with clear description
5. **Ensure** your extension works and follows security guidelines

### 🔍 Quality Guidelines
- ✅ **Tested** and working extensions only
- ✅ **Clear** and helpful descriptions
- ✅ **Proper** categorization
- ✅ **Security** best practices followed
- ✅ **Maintained** and actively supported

### 🏷️ Submission Template
```markdown
- [Extension Name](repository-link) - Brief but descriptive explanation of what the extension does and its key features.
```
...
### 💬 Discussion Forums
- [💭 r/ClaudeDesktop](https://www.reddit.com/r/ClaudeDesktop) - Main community discussion
- [🗣️ r/dxt](https://www.reddit.com/r/dxt) - Extension-specific discussions
- [🤝 Discord Server](https://discord.gg/claude-extensions) - Real-time chat and support
- [📱 Telegram Group](https://t.me/claude_extensions) - Quick questions and updates

### 🎯 Special Interest Groups
- [⚙️ Developer Tools SIG](https://github.com/claude-extensions/dev-tools) - For development-focused extensions
- [🤖 AI Integration SIG](https://github.com/claude-extensions/ai-integration) - AI and ML focused extensions
- [💼 Enterprise SIG](https://github.com/claude-extensions/enterprise) - Business and enterprise solutions

### 🏆 Hall of Fame
- [👑 Extension of the Month](https://github.com/samihalawa/awesome-claude-dxt/wiki/Extension-of-the-Month)
- [⭐ Community Choice Awards](https://github.com/samihalawa/awesome-claude-dxt/wiki/Community-Awards)
- [🚀 Innovation Showcase](https://github.com/samihalawa/awesome-claude-dxt/wiki/Innovation-Showcase)
...
### 📅 Latest Changes
- **2025-01-01**: Added 50+ new extensions across all categories
- **2024-12-30**: Launched Featured Extensions section
- **2024-12-25**: Enhanced documentation and tutorials
- **2024-12-20**: Added community guidelines and contribution templates
- **2024-12-15**: Reorganized categories with emoji navigation

### 📈 Growth Stats
- **500+** Total Extensions
...
### 🔮 Coming Soon
- [ ] **Extension Marketplace** - Centralized discovery and installation
- [ ] **Rating System** - Community-driven extension ratings
- [ ] **Auto-Updates** - Seamless extension updating mechanism
- [ ] **Extension Templates** - Quick-start templates for common patterns
- [ ] **Performance Monitoring** - Real-time extension performance tracking

### 🚀 Future Goals
- [ ] **1000+ Extensions** by end of 2025
- [ ] **Mobile Support** for Claude mobile apps
- [ ] **Enterprise Dashboard** for organization-wide extension management
- [ ] **AI-Powered Discovery** - Smart extension recommendations
- [ ] **Multi-Language Support** - Extensions in multiple programming languages
...
<div align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=samihalawa&repo=awesome-claude-dxt&show_icons=true&theme=vue" alt="Repository Stats"/>
</div>
...
### 🏢 Special Thanks
- **Anthropic Team** - For creating Claude Desktop Extensions
- **MCP Community** - For building the foundation
- **Extension Developers** - For creating amazing tools
- **Contributors** - For maintaining this repository

### 🎖️ Top Contributors
- [@milisp](https://github.com/milisp) - Original creator and maintainer
- [@samihalawa](https://github.com/samihalawa) - Enhanced version maintainer
- [@anthropic-team](https://github.com/anthropics) - Official support and guidance
...
<div align="center">
  ...
  <p>Help others discover amazing Claude Desktop Extensions</p>
  
  [![GitHub stars](https://img.shields.io/github/stars/samihalawa/awesome-claude-dxt?style=social)](https://github.com/samihalawa/awesome-claude-dxt/stargazers)
  [![GitHub forks](https://img.shields.io/github/forks/samihalawa/awesome-claude-dxt?style=social)](https://github.com/samihalawa/awesome-claude-dxt/network)
